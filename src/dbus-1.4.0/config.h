...
#define DBUS_BINDIR "/home/waker/prj/deadbeef-deps/lib-x86-64/bin"
...
#define DBUS_DAEMONDIR "/home/waker/prj/deadbeef-deps/lib-x86-64/bin"

/* Name of executable */
#define DBUS_DAEMON_NAME "dbus-daemon"

/* Directory for installing DBUS data files */
#define DBUS_DATADIR "/home/waker/prj/deadbeef-deps/lib-x86-64/share"
...
#define DBUS_LIBEXECDIR "/home/waker/prj/deadbeef-deps/lib-x86-64/libexec"

/* Prefix for installing DBUS */
#define DBUS_PREFIX "/home/waker/prj/deadbeef-deps/lib-x86-64"
...
#define DBUS_TEST_LAUNCH_HELPER_BINARY "/home/waker/prj/deadbeef-deps/dbus-1.4.0/bus/dbus-daemon-launch-helper-test"
...
#define TEST_BUS_BINARY "/home/waker/prj/deadbeef-deps/dbus-1.4.0/bus/dbus-daemon"

/* Full path to test file test/test-exit in builddir */
#define TEST_EXIT_BINARY "/home/waker/prj/deadbeef-deps/dbus-1.4.0/test/test-exit"

/* Full path to test file test/data/invalid-service-files in builddir */
#define TEST_INVALID_SERVICE_DIR "/home/waker/prj/deadbeef-deps/dbus-1.4.0/test/data/invalid-service-files"

/* Full path to test file test/data/invalid-service-files-system in builddir
   */
#define TEST_INVALID_SERVICE_SYSTEM_DIR "/home/waker/prj/deadbeef-deps/dbus-1.4.0/test/data/invalid-service-files-system"

/* Full path to test file test/name-test/test-privserver in builddir */
#define TEST_PRIVSERVER_BINARY "/home/waker/prj/deadbeef-deps/dbus-1.4.0/test/name-test/test-privserver"

/* Full path to test file test/test-segfault in builddir */
#define TEST_SEGFAULT_BINARY "/home/waker/prj/deadbeef-deps/dbus-1.4.0/test/test-segfault"

/* Full path to test file test/test-service in builddir */
#define TEST_SERVICE_BINARY "/home/waker/prj/deadbeef-deps/dbus-1.4.0/test/test-service"

/* Full path to test file test/test-shell-service in builddir */
#define TEST_SHELL_SERVICE_BINARY "/home/waker/prj/deadbeef-deps/dbus-1.4.0/test/test-shell-service"

/* Full path to test file test/test-sleep-forever in builddir */
#define TEST_SLEEP_FOREVER_BINARY "/home/waker/prj/deadbeef-deps/dbus-1.4.0/test/test-sleep-forever"

/* Full path to test file test/data/valid-service-files in builddir */
#define TEST_VALID_SERVICE_DIR "/home/waker/prj/deadbeef-deps/dbus-1.4.0/test/data/valid-service-files"

/* Full path to test file test/data/valid-service-files-system in builddir */
#define TEST_VALID_SERVICE_SYSTEM_DIR "/home/waker/prj/deadbeef-deps/dbus-1.4.0/test/data/valid-service-files-system"
