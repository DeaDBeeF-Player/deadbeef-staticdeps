...
libs="swift-corelibs-libdispatch-swift-5.5-RELEASE libsndfile-1.0.28 libcdio-2.1.0 libcdio-paranoia-10.2+2.0.1 alsa-lib-1.0.25 mbedtls-2.7.19 curl-7.79.1 json-glib-0.14.2 expat-2.0.1 dbus-1.4.0 dbus-glib-0.100 zlib-1.2.5 libzip-1.5.2 jpeg-8c libmad-0.15.1b libxml2-2.7.8 mpg123-1.33.6 libogg-1.3.2 libvorbis-1.3.4 flac-1.5.0 libpng-1.6.55 libsamplerate-0.1.9 opus-1.1 opusfile-0.6 sqlite-autoconf-3080301 libcddb-1.3.2 opencore-amr-0.1.2 ffmpeg-8.1.2 jansson-2.12 fftw-3.3.8 faad2-2.8.8 wavpack-5.1.0"
