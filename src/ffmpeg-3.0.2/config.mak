...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--extra-cflags='-fPIC -I/home/waker/prj/deadbeef-staticdeps/lib-x86-32/include/opus -m32 -I/home/waker/prj/deadbeef-staticdeps/lib-x86-32/include/i386-linux-gnu -O2 -D_GNU_SOURCE -D_FORTIFY_SOURCE=0 -fPIC -I/home/waker/prj/deadbeef-staticdeps/lib-x86-32/include' --enable-pic --enable-static --enable-gpl --disable-doc --disable-ffplay --disable-ffprobe --disable-ffserver --disable-avdevice --disable-ffmpeg --disable-postproc --disable-swresample --disable-avfilter --disable-swscale --enable-network --disable-swscale-alpha --disable-vdpau --disable-videotoolbox --disable-dxva2 --enable-hwaccels --disable-encoders --disable-muxers --disable-indevs --disable-outdevs --disable-devices --disable-filters --disable-parsers --enable-parser=ac3 --enable-demuxer=ac3 --disable-bsfs --disable-bzlib --disable-protocols --disable-decoders --enable-decoder=libopus --enable-libopus --enable-decoder=wmapro --disable-decoder=wmav1 --disable-decoder=wmav2 --enable-decoder=wmavoice --disable-decoder=alac --enable-decoder=ac3 --enable-decoder=amrnb --disable-demuxers --enable-demuxer=asf --disable-demuxer=mov --enable-demuxer=oma --enable-demuxer=ac3 --enable-demuxer=amr --enable-demuxer=ogg --enable-demuxer=tak --enable-decoder=tak --enable-decoder=dsd_lsbf --enable-decoder=dsd_lsbf_planar --enable-decoder=dsd_msbf --enable-decoder=dsd_msbf_planar --enable-demuxer=dsf --enable-demuxer=iff --enable-libopencore-amrnb --enable-libopencore-amrwb --enable-version3 --disable-mmx --disable-yasm --enable-protocol=file --enable-protocol=http --prefix=/home/waker/prj/deadbeef-staticdeps/lib-x86-32
prefix=/home/waker/prj/deadbeef-staticdeps/lib-x86-32
...
CFLAGS=-m32 -I/home/waker/prj/deadbeef-staticdeps/lib-x86-32/include/i386-linux-gnu -O2 -D_GNU_SOURCE -D_FORTIFY_SOURCE=0 -fPIC -I/home/waker/prj/deadbeef-staticdeps/lib-x86-32/include  -fPIC -I/home/waker/prj/deadbeef-staticdeps/lib-x86-32/include/opus -m32 -I/home/waker/prj/deadbeef-staticdeps/lib-x86-32/include/i386-linux-gnu -O2 -D_GNU_SOURCE -D_FORTIFY_SOURCE=0 -fPIC -I/home/waker/prj/deadbeef-staticdeps/lib-x86-32/include -std=c99 -fomit-frame-pointer -fPIC -pthread -I/home/waker/prj/deadbeef-staticdeps/lib-x86-32/include/opus  -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
OBJCFLAGS=  
ASFLAGS=  -fPIC -I/home/waker/prj/deadbeef-staticdeps/lib-x86-32/include/opus -m32 -I/home/waker/prj/deadbeef-staticdeps/lib-x86-32/include/i386-linux-gnu -O2 -D_GNU_SOURCE -D_FORTIFY_SOURCE=0 -fPIC -I/home/waker/prj/deadbeef-staticdeps/lib-x86-32/include -fPIC -g
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
DEPWINDRES=gcc
DOXYGEN=doxygen
LDFLAGS=-m32 -L/home/waker/prj/deadbeef-staticdeps/lib-x86-32/lib  -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
...
EXTRALIBS=-lxcb -lX11 -L/home/waker/prj/deadbeef-staticdeps/lib-x86-32/lib -lopus -lopencore-amrwb -lopencore-amrnb -lm -lz -pthread 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
