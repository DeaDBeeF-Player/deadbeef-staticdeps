...
main(int argc, const char *argv[])
{
  ...
  if (cdio_have_driver(DRIVER_BINCUE)) {
      p_cdio = cdio_open("/home/waker/prj/deadbeef-staticdeps/libcdio-paranoia-10.2+0.93+1/test/data/cdda.cue", DRIVER_UNKNOWN);
  } else if (cdio_have_driver(DRIVER_CDRDAO)) {
      p_cdio = cdio_open("/home/waker/prj/deadbeef-staticdeps/libcdio-paranoia-10.2+0.93+1/test/data/cdda.toc", DRIVER_UNKNOWN);
  } else {
