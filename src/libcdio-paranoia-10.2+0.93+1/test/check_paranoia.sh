...
if test ! -d "$abs_top_builddir" ; then
  abs_top_builddir=/home/waker/prj/deadbeef-staticdeps/libcdio-paranoia-10.2+0.93+1
fi

if test ! -d "$abs_top_srcdir" ; then
  abs_top_srcdir=/home/waker/prj/deadbeef-staticdeps/libcdio-paranoia-10.2+0.93+1
fi
