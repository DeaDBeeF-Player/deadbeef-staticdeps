...
main(int argc, const char *argv[])
{
  ...
  if (cdio_have_driver(DRIVER_BINCUE)) {
      cdObj = cdio_open("/home/waker/prj/deadbeef-staticdeps/libcdio-0.93/test/data/cdda.cue", DRIVER_UNKNOWN);
  } else if (cdio_have_driver(DRIVER_CDRDAO)) {
      cdObj = cdio_open("/home/waker/prj/deadbeef-staticdeps/libcdio-0.93/test/data/cdda.toc", DRIVER_UNKNOWN);
  } else {
